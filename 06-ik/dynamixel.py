...
class Dynamixel:
    ...
    def set_velocity_profile(self, motor_id, velocity_profile):
        dxl_comm_result, dxl_error = self.packetHandler.write4ByteTxRx(self.portHandler, motor_id,
                                                                       self.ADDR_PROFILE_VELOCITY, velocity_profile)

    def set_acceleration_profile(self, motor_id, acceleration_profile):
        dxl_comm_result, dxl_error = self.packetHandler.write4ByteTxRx(self.portHandler, motor_id,
                                                                       self.ADDR_PROFILE_ACCELERATION, acceleration_profile)
